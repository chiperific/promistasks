...
module Constant
  ...
  class Params
    ACTIONS = %w[alerts api_sync clear_completed_jobs complete current_user_id destroy edit find_id_by_name google_oauth2 new owner_enum property_enum subject_enum tasks tasks_filter un_complete users update_skills update_tasks update_users].freeze
  end
end
