...
class TaskClient
  ...
  #   HTTParty.get(BASE_URI + args[:tasklist_gid] + '/tasks/' + task_user.google_id, headers: headers(user).as_json)
  # end

  # def insert(task_user)
  #   user = task_user.user
  #   task = task_user.task
  #   user.refresh_token!
  ...
  #   HTTParty.post(BASE_URI + task_user.tasklist_id + '/tasks/', { headers: headers(user).as_json, body: body.to_json })
  # end

  # def update(task_user)
  #   user = task_user.user
  #   task = task_user.task
  #   user.refresh_token!
  ...
  #     due:       task.due.present? ? task.due.utc.rfc3339(3) : nil
  #   }
  #   HTTParty.patch(BASE_URI + task_user.tasklist_id + '/tasks/' + task_user.google_id, { headers: headers(user).as_json, body: body.to_json })
  # end
  ...
  #   HTTParty.delete(BASE_URI + args[:tasklist_gid] + '/tasks/' + task_user.google_id, headers: headers(user).as_json)
  # end
