...
RSpec.describe 'View reports', type: :system do
  before :each do
    visit root_path
  end
  ...
  context 'when current_user' do
    context 'is client' do
      ...
      it 'redirects away' do
        expect(current_path).not_to eq reports_properties_path
      end
    end
  ...
  context 'when #records are present' do
    ...
    it 'shows the #records' do
      expect(page).to have_css("table#dttb-report")
      expect(page).to have_content Property.first.name
    end
  end
