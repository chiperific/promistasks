...
RSpec.describe 'View skills', type: :system do
  before :each do
    visit root_path
  end
  ...
  context 'when current_user' do
    context 'is client' do
      ...
      it 'redirects away' do
        expect(current_path).not_to eq skills_path
      end
    end
    ...
    context 'is staff' do
      ...
      it 'loads the page' do
        ...
        expect(page).to have_css 'a#new_skill_link'
      end
    end
  ...
  context 'when skills are present' do
    ...
    it 'shows the skills' do
      expect(page).to have_css 'tr.skill-row', count: 3
    end
  end

  context 'when skills are not present' do
    before :each do
      user = create(:admin)
      login_as(user, scope: :user)
      visit skills_path
