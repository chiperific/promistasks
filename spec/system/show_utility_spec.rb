...
RSpec.describe 'Show utility', type: :system do
  before :each do
  ...
  context 'when current_user' do
    context 'is client' do
      ...
      it 'redirects away' do
        expect(current_path).not_to eq utility_path(@utility)
      end
    end
    ...
    context 'is staff' do
      ...
      it 'loads the page' do
        ...
        expect(page).to have_content 'Point of Contact'
      end
    end
